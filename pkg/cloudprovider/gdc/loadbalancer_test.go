...
func TestGetLoadBalancerLancer(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (tt.wantErr && err == nil) || (!tt.wantErr && err != nil) {
				t.Fatalf("GetLoadBalancerLancer(%q) returned unexpected error (-want %v\n+got%v)", tt.name, tt.wantErr, err)
			}
			if err != nil {
				return
			}
			if diff := cmp.Diff(tt.want, gotResponse); diff != "" {
				t.Errorf("GetLoadBalancerLancer(%q) returned unexpected diff (-want +got):\n%s", tt.name, diff)
			}
		})
	}
}
func TestGetLoadBalancerLancerWithSmallerActiveZones(t *testing.T) {
	gdc, globalScheme, _, err := initFakeGDC()
	if err != nil {
		t.Fatalf("initFakeGDC throws error - %s", err.Error())
	}
...
func TestGetLoadBalancerLancerName(t *testing.T) {
	...
	if name != lbName {
		t.Errorf("GetLoadBalancerLancerName() got = %v, want = %v", name, lbName)
	}
}

func TestEnsureLoadBalancerLancer(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := fetchAndCompareLBObjs(tt.wantGlobalObjs, tt.wantZonalObjs, tt.globalClient, tt.zonalClients); err != nil {
				t.Errorf("EnsureLoadBalancerLancer(%q) returned error %v", tt.name, err)
			}
		})
	}
}

func TestUpdateLoadBalancerLancer(t *testing.T) {
	gdc, globalScheme, zonalScheme, err := initFakeGDC()
	if err != nil {
		t.Fatalf("initFakeGDC throws error - %s", err.Error())
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := fetchAndCompareLBObjs(tt.wantGlobalObjs, tt.wantZonalObjs, tt.globalClient, tt.zonalClients); err != nil {
				t.Errorf("UpdateLoadBalancerLancer(%q) returned error %v", tt.name, err)
			}
		})
	}
}

func TestEnsureLoadBalancerLancerDeleted(t *testing.T) {
	gdc, globalScheme, zonalScheme, err := initFakeGDC()
	if err != nil {
		t.Fatalf("initFakeGDC throws error - %s", err.Error())
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := fetchAndCompareLBObjs(tt.wantGlobalObjs, tt.wantZonalObjs, tt.globalClient, tt.zonalClients); err != nil {
				t.Errorf("EnsureLoadBalancerLancerDeleted(%q) returned error %v", tt.name, err)
			}
		})
	}
}
...
func initFakeGDC() (*cloud, *runtime.Scheme, *runtime.Scheme, error) {
	...
	c.lb = lb
	return c, globalScheme, zonalScheme, nil
}
