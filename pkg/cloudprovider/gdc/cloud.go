...
import (
	...
	gdcclient "sapbtp.googlesource.com/cloud-provider-gdch/gdc/pkg/client"
	gdcconstants "sapbtp.googlesource.com/cloud-provider-gdch/gdc/pkg/constants"
	"sapbtp.googlesource.com/cloud-provider-gdch/pkg/instance"
)
...
const (
	...
	lbSelectorLabel  = gdcconstants.WorkloadLabelSelectorKey
...
// This interface method is not supported in legacy GDC but implemented for lancer MultiZone.
